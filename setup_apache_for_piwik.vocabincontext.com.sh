...
tugboat ssh monitoring -p 2222 <<"EOF"
...
rsync --copy-links -e "ssh -o StrictHostKeyChecking=no -p 2222" -r -v tls/certs/piwik.vocabincontext.com/ root@$INSTANCE_IP:/etc/letsencrypt/live/piwik.vocabincontext.com
